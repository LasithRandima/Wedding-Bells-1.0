...
class BookingPolicy
{
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(User $user, ClientVendorBooking $clientVendorBooking)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(User $user, ClientVendorBooking $clientVendorBooking)
    {
        return auth()->user()->role_id === 2;
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, ClientVendorBooking $clientVendorBooking)
    {
        //
    }
