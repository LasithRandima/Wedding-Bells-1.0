...
final class client_guest_lists extends PowerGridComponent
{
    use ActionButton;
    ...
    public function columns(): array
    {
        ...
        return [
            ...
            Column::add()
                ...
                ->makeInputSelect(ClientGuestList::select('group')->distinct()->get(), 'group', 'group')
                ->editOnClick($canEdit),
