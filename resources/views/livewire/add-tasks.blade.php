...
<div>
    <form class="mb-4" wire:submit.prevent="addTask">

        <div class="flex-fill mb-3">
        {{-- <label class="form-label" for="form2"></label> --}}
          <input type="text" id="form2" placeholder="New task..." class="form-control" wire:model="TaskName" />
          @error('TaskName')
        ...
        <div class="flex-fill mb-3 border-1">
            <input type="text" id="form2" placeholder="Description..." class="form-control" wire:model="TaskDescription" />
            @error('TaskDescription')
            <span class="badge badge-danger">{{$message}}</span>
             @enderror
        </div>
        <div class="flex-fill mb-3">
            <select id="form2" class="form-control form-outline" wire:model="TaskCategory" >
        ...
        <div class="flex-fill mt-3">
            <select id="form2" class="form-control" wire:model="TaskDate">
        ...
        <div class="flex-fill mt-3">
            <input class="form-check-input me-2" type="checkbox" value="" aria-label="..." id="essential"  wire:model="EssentialTask"  />
        ...
        <button type="submit" class="btn btn-info mt-3 mb-4">Add</button>
      </form>
